"""Génère les slides docs/slides-fr.pptx à partir des figures de docs/figures/."""
...
def rect(slide, left, t, w, h, color, line=None):
...
def bullets(slide, left, t, w, h, items, size=18, color=GRAY, gap=10):
    tb = slide.shapes.add_textbox(left, t, w, h)
    tf = tb.text_frame
    tf.word_wrap = True
...
def content_slide(title, presenter, section_no):
    ...
    # title
    txt(s, Inches(0.6), Inches(0.42), Inches(9.6), Inches(0.9), title, 26, NAVY, bold=True)
    # presenter tag (top-right)
    rect(s, Inches(11.0), Inches(0.4), Inches(1.9), Inches(0.5), PRESENTERS[presenter])
    txt(
        s,
        Inches(11.0),
        Inches(0.4),
    ...
    txt(s, Inches(0.6), Inches(7.0), Inches(4), Inches(0.4), section_no, 11, LGRAY)
    return s
...
txt(
    ...
    Inches(11.3),
    Inches(0.8),
    "D'un pipeline classique aux réseaux profonds",
    22,
    RGBColor(0xCF, 0xDB, 0xEC),
    align=PP_ALIGN.CENTER,
    italic=True,
)
txt(
    ...
    Inches(11.3),
    Inches(0.6),
    "Evrard Lecureur   ·   Romain Ben   ·   Zouhair Saitout",
    20,
    WHITE,
    bold=True,
    align=PP_ALIGN.CENTER,
...
for label, col, who in plan:
    ...
    txt(s, Inches(5.5), Inches(y), Inches(6.2), Inches(0.9), label, 19, GRAY, bold=True, anchor=MSO_ANCHOR.MIDDLE)
    txt(s, Inches(11.7), Inches(y), Inches(1.5), Inches(0.9), who, 13, col, bold=True, anchor=MSO_ANCHOR.MIDDLE)
    y += 1.12
...
fitted(s, fig("class_balance.png"), Inches(6.5), Inches(1.7), Inches(6.3), Inches(4.6))

# 4. Découpage
s = content_slide("Préparation 1 : découper autour du chien", "Evrard", "1 · Données")
fitted(s, fig("bounding_box_crop.png"), Inches(0.6), Inches(1.6), Inches(8.3), Inches(5.3))
bullets(
    s,
    Inches(9.2),
    Inches(2.2),
...
fitted(s, fig("preprocessing_comparison.png"), Inches(0.6), Inches(1.6), Inches(8.3), Inches(5.3))
bullets(
    s,
    Inches(9.2),
    Inches(2.0),
...
fitted(s, fig("pca_reconstruction.png"), Inches(0.6), Inches(1.55), Inches(7.0), Inches(5.4))
fitted(s, fig("pca_approximation.png"), Inches(7.7), Inches(1.55), Inches(5.2), Inches(3.0))
bullets(
    s,
    Inches(7.8),
    Inches(4.9),
...
fitted(s, fig("pca_scatter_plots.png"), Inches(0.6), Inches(1.6), Inches(7.4), Inches(5.3))
...
txt(s, Inches(8.5), Inches(2.55), Inches(4.0), Inches(0.5), "Message clé", 18, ORANGE, bold=True)

# 8. HOG
s = content_slide("HOG : décrire les contours", "Romain", "2 · Caractéristiques")
fitted(s, fig("sobel_hog.png"), Inches(0.6), Inches(1.6), Inches(8.0), Inches(5.3))
bullets(
    s,
    Inches(8.9),
    Inches(2.1),
...
fitted(s, fig("task6_analysis.png"), Inches(0.5), Inches(1.7), Inches(12.3), Inches(4.3))
cols = [
...
for text, x in cols:
    txt(s, x, Inches(6.15), Inches(4.1), Inches(1.1), text, 14, GRAY, align=PP_ALIGN.CENTER)

# 10. kNN erreurs
s = content_slide("Où le kNN se trompe", "Romain", "3 · kNN")
fitted(s, fig("confusion_matrix_knn.png"), Inches(0.7), Inches(1.7), Inches(6.6), Inches(5.1))
bullets(
    s,
    Inches(7.7),
    Inches(2.3),
...
for i, (a, bcell, kind) in enumerate(rows):
    ...
    if kind is True:
        ...
        c = PRESENTERS["Zouhair"]
        bold = True
    else:
        rect(s, tx, yy, tw, rh, LIGHT if i % 2 else WHITE)
        c = GRAY
        bold = False
    txt(s, tx + Inches(0.25), yy, Inches(3.8), rh, a, 17, c, bold=bold, anchor=MSO_ANCHOR.MIDDLE)
    txt(
        s,
        tx + Inches(4.0),
        yy,
...
fitted(s, fig("confusion_matrix.png"), Inches(2.0), Inches(1.6), Inches(6.4), Inches(5.3))
bullets(
    s,
    Inches(8.7),
    Inches(2.4),
...
fitted(s, fig("confusion_matrix_vgg16.png"), Inches(6.9), Inches(1.5), Inches(6.0), Inches(5.3))

# 15. Conclusion
s = prs.slides.add_slide(BLANK)
rect(s, 0, 0, SW, SH, NAVY)
rect(s, 0, Inches(1.7), SW, Inches(0.06), ORANGE)
txt(s, Inches(1.0), Inches(0.9), Inches(11.3), Inches(0.8), "Conclusion", 34, WHITE, bold=True, align=PP_ALIGN.CENTER)
bullets_items = [
...
out = os.path.join(HERE, "..", "docs", "slides-fr.pptx")
prs.save(out)
