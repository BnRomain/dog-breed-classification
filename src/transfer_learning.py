"""Transfer learning: frozen VGG16 (or Xception) features with a small trained head.

Requires TensorFlow (pip install tensorflow). The ImageNet weights are downloaded on first run.
"""
...
# 1. IMPORTATION MODULAIRE DE preprocessing_knn.py
...
from preprocessing_knn import get_resized_db, read_and_crop_db  # noqa: E402

# Configuration des dossiers de sortie
PROJECT_DIR = os.path.join(SCRIPT_DIR, "..")
FIGS_DIR = os.path.join(PROJECT_DIR, "docs", "figures")
...
print("Step 1: Loading dataset in COLOR (RGB) via preprocessing_knn utilities...")
